...
<?php $this->widget('ext.etooltipster.EToolTipster', array('target' => '.tooltip','options' => array('theme' => 'tooltipster-shadow','animation'=>'fall','position'=>'left'))); ?>
	...
	<li><a href="#">Reportes</a>
		<ul>
			...
			<li><?php echo CHtml::link('Atenciones por mes',array('reportes/atencionesPorMes')); ?></li>
	...
	<li><a href="#">TESORERIA</a>
		<ul>	
			<li style="height:35px;"><?php echo CHtml::link('GESTIÓN DE PACIENTES CON ASEGURADORA',array('pacientesAseguradora/admin')); ?></li>
