 ...
 class printWidget extends CWidget
{
    ...
    * and the content of this file is absolutely up to you!
    */
	public $cssFile = 'impresionOficioHistorial.css';
    ...
    */
    ...
    public function init()
    {
        ...
        echo CHtml::link("<div id='printer' style='margin-top:-23px;'><img src='images/print.png' style='width:100%;height:auto;' title='Imprimir oficio y su historial' alt='Imprimir oficio y su historial'></div>", 
