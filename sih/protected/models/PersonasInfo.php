...
/**
 * This is the model class for table "personas_info".
 *
 * The followings are the available columns in table 'personas_info':
 * @property integer $id
 * @property string $calle_num
 ...
 */
class PersonasInfo extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'personases' => array(self::HAS_MANY, 'Personas', 'id_personas_info'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('calle_num',$this->calle_num,true);
	 ...
	 * @return PersonasInfo the static model class
	 */
