...
//			var_dump(isset($_POST['actualizar']));
			...
			$permisos = (isset($_POST['actualizar']) ? "1" : "0")."".(isset($_POST['borrar']) ? "1" : "0")."".(isset($_POST['crear']) ? "1" : "0")."".(isset($_POST['ver']) ? "1" : "0");
	 ...
	 * @return RolesModulos the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=RolesModulos::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param RolesModulos $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='roles-modulos-form')
		{
