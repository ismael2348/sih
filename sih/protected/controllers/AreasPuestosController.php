...
class AreasPuestosController extends Controller
{
	/**
	...
	{
		$dataProvider=new CActiveDataProvider('AreasPuestos');
	...
	{
		$model=new AreasPuestos('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['AreasPuestos']))
			$model->attributes=$_GET['AreasPuestos'];
	 ...
	 * @return AreasPuestos the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=AreasPuestos::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param AreasPuestos $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='areas-puestos-form')
		{
