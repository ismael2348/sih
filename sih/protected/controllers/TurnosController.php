...
class TurnosController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Turnos']))
		{
			...
			//if(array_key_exists("GESTION DE TURNOS", Yii::app()->user->permisos) && Yii::app()->user->permisos["GESTION DE TURNOS"][1] == "1")
		$this->render('create',array(
			'model'=>$model,
		));
	//else
		//echo "No tienes permisos para realizar esta acción. <meta http-equiv='refresh' content='3;url=?r=turnos/admin' />";
